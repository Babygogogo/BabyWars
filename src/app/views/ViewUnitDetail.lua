...
local function createLabel()
    local label = cc.Label:createWithTTF("Infantry units have the lowest deployment cost. They can capture bases but have low firepower.", "res/fonts/msyhbd.ttc", 25)
