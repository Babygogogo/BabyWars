...
local MENU_LIST_VIEW_HEIGHT       = MENU_TITLE_POS_Y - BUTTON_FIND_POS_Y - BUTTON_FIND_HEIGHT
...
local function initMenuTitle(self)
    local title = cc.Label:createWithTTF(LocalizationFunctions.getLocalizedText(1, "JoinWar"), ITEM_FONT_NAME, MENU_TITLE_FONT_SIZE)
