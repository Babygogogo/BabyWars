...
local ViewExitWarSelector = class("ViewExitWarSelector", cc.Node)
...
local function initMenuTitle(self)
    local title = cc.Label:createWithTTF(LocalizationFunctions.getLocalizedText(14, "ExitWar"), ITEM_FONT_NAME, MENU_TITLE_FONT_SIZE)
...
--------------------------------------------------------------------------------
function ViewExitWarSelector:ctor(param)
...
function ViewExitWarSelector:setViewWarFieldPreviewer(view)
    assert(self.m_ViewWarFieldPreviewer == nil, "ViewExitWarSelector:setViewWarFieldPreviewer() the view has been set.")
...
function ViewExitWarSelector:setViewWarConfigurator(view)
    assert(self.m_ViewWarConfigurator == nil, "ViewExitWarSelector:setViewWarConfigurator() the view has been set.")
...
--------------------------------------------------------------------------------
function ViewExitWarSelector:removeAllItems()
    self.m_MenuListView:removeAllItems()

    return self
end

function ViewExitWarSelector:showWarList(list)
...
function ViewExitWarSelector:createAndPushBackItem(item)
    self.m_MenuListView:pushBackCustomItem(createViewMenuItem(item))

    return self
end

function ViewExitWarSelector:setButtonNextVisible(visible)
    self.m_ButtonNext:setVisible(visible)

    return self
end

function ViewExitWarSelector:setMenuVisible(visible)
