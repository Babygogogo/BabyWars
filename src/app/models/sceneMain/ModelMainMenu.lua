    ...
    self.m_ItemChangeLanguage = {
        ...
        callback = function()
            ...
            if (LocalizationFunctions.getLanguageCode() == codes.Chinese) then
                ...
                SingletonGetters.getModelMessageIndicator(self.m_ModelSceneMain):showMessage(getLocalizedText(22, codes.English))
            else
                LocalizationFunctions.setLanguageCode(codes.Chinese)
                SingletonGetters.getModelMessageIndicator(self.m_ModelSceneMain):showMessage(getLocalizedText(22, codes.Chinese))
            end
        end,
    }
end
