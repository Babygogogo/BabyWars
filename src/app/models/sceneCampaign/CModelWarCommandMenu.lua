...
local CModelWarCommandMenu = class("CModelWarCommandMenu")
...
--------------------------------------------------------------------------------
function CModelWarCommandMenu:ctor(param)
...
--------------------------------------------------------------------------------
function CModelWarCommandMenu:onStartRunning(modelSceneWar)
...
function CModelWarCommandMenu:onEvent(event)
...
--------------------------------------------------------------------------------
function CModelWarCommandMenu:isEnabled()
    return self.m_State ~= "stateDisabled"
end

function CModelWarCommandMenu:setEnabled(enabled)
    if (enabled) then
        setStateMain(self)
    else
        setStateDisabled(self)
...
function CModelWarCommandMenu:onButtonBackTouched()
    ...
    else                                       error("CModelWarCommandMenu:onButtonBackTouched() the state is invalid: " .. (state or ""))
    end

    return self
end

return CModelWarCommandMenu
