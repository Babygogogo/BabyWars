...
GameConstant.skills = {
    ...
    globalDefenseModifier = {
        levels = {
            ...
            [-28] = {modifier = -28, points = -186.67, },
            [-27] = {modifier = -27, points = -180,    },
            [-26] = {modifier = -26, points = -173.33, },
            [-25] = {modifier = -25, points = -166.67, },
            [-24] = {modifier = -24, points = -160,    },
            [-23] = {modifier = -23, points = -153.33, },
            [-22] = {modifier = -22, points = -146.67, },
            [-21] = {modifier = -21, points = -140,    },
            [-20] = {modifier = -20, points = -133.33, },
            [-19] = {modifier = -19, points = -126.67, },
            [-18] = {modifier = -18, points = -120,    },
            [-17] = {modifier = -17, points = -113.33, },
            [-16] = {modifier = -16, points = -106.67, },
            [-15] = {modifier = -15, points = -100,    },
            [-14] = {modifier = -14, points = -93.33,  },
            [-13] = {modifier = -13, points = -86.67,  },
            [-12] = {modifier = -12, points = -80,     },
            [-11] = {modifier = -11, points = -73.33,  },
            [-10] = {modifier = -10, points = -66.67,  },
            [-9]  = {modifier = -9,  points = -60,     },
            [-8]  = {modifier = -8,  points = -53.33,  },
            [-7]  = {modifier = -7,  points = -46.67,  },
            [-6]  = {modifier = -6,  points = -40,     },
            [-5]  = {modifier = -5,  points = -33.33,  },
            [-4]  = {modifier = -4,  points = -26.67,  },
            [-3]  = {modifier = -3,  points = -20,     },
            [-2]  = {modifier = -2,  points = -13.33,  },
            [-1]  = {modifier = -1,  points = -6.67,   },
            [0]   = {modifier = 0,   points = 0,       },
            [1]   = {modifier = 1,   points = 6.67,    },
            [2]   = {modifier = 2,   points = 13.33,   },
            [3]   = {modifier = 3,   points = 20,      },
    ...
    globalCostModifier = {
        levels = {
            [-30] = {modifier = 30,  points = -400,    },
            [-29] = {modifier = 29,  points = -386.67, },
            [-28] = {modifier = 28,  points = -373.33, },
            [-27] = {modifier = 27,  points = -360,    },
            [-26] = {modifier = 26,  points = -346.67, },
            [-25] = {modifier = 25,  points = -333.33, },
            [-24] = {modifier = 24,  points = -320,    },
            [-23] = {modifier = 23,  points = -306.67, },
            [-22] = {modifier = 22,  points = -293.33, },
            [-21] = {modifier = 21,  points = -280,    },
            [-20] = {modifier = 20,  points = -266.67, },
            [-19] = {modifier = 19,  points = -253.33, },
            [-18] = {modifier = 18,  points = -240,    },
            [-17] = {modifier = 17,  points = -226.67, },
            [-16] = {modifier = 16,  points = -213.33, },
            [-15] = {modifier = 15,  points = -200,    },
            [-14] = {modifier = 14,  points = -186.67, },
            [-13] = {modifier = 13,  points = -173.33, },
            [-12] = {modifier = 12,  points = -160,    },
            [-11] = {modifier = 11,  points = -146.67, },
            [-10] = {modifier = 10,  points = -133.33, },
            [-9]  = {modifier = 9,   points = -120,    },
            [-8]  = {modifier = 8,   points = -106.67, },
            [-7]  = {modifier = 7,   points = -93.33,  },
            [-6]  = {modifier = 6,   points = -80,     },
            [-5]  = {modifier = 5,   points = -66.67,  },
            [-4]  = {modifier = 4,   points = -53.33,  },
            [-3]  = {modifier = 3,   points = -40,     },
            [-2]  = {modifier = 2,   points = -26.67,  },
            [-1]  = {modifier = 1,   points = -13.33,  },
            [0]   = {modifier = 0,   points = 0,       },
            [1]   = {modifier = -1,  points = 13.33,   },
            [2]   = {modifier = -2,  points = 26.67,   },
            [3]   = {modifier = -3,  points = 40,      },
