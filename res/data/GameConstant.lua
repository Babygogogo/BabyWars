...
GameConstant.skills = {
    ...
    [14] = {
        ...
        levels       = {
            ...
            [2] = {modifier = 10, pointsPassive = 160, pointsActive = 100, minEnergy = 1},
            [3] = {modifier = 15, pointsPassive = 240, pointsActive = 150, minEnergy = 1},
            [4] = {modifier = 20, pointsPassive = 320, pointsActive = 200, minEnergy = 2},
            [5] = {modifier = 25, pointsPassive = 400, pointsActive = 250, minEnergy = 2},
            [6] = {modifier = 30, pointsPassive = 480, pointsActive = 300, minEnergy = 2},
            [7] = {modifier = 35, pointsPassive = 560, pointsActive = 350, minEnergy = 3},
            [8] = {modifier = 40, pointsPassive = 640, pointsActive = 400, minEnergy = 3},
            [9] = {modifier = 45, pointsPassive = 720, pointsActive = 450, minEnergy = 3},
            [10] = {modifier = 50, pointsPassive = 800, pointsActive = 500, minEnergy = 4},
            [11] = {modifier = 55, pointsPassive = 880, pointsActive = 550, minEnergy = 4},
            [12] = {modifier = 60, pointsPassive = 960, pointsActive = 600, minEnergy = 4},
            [13] = {modifier = 65, pointsPassive = 1040, pointsActive = 650, minEnergy = 5},
            [14] = {modifier = 70, pointsPassive = 1120, pointsActive = 700, minEnergy = 5},
            [15] = {modifier = 75, pointsPassive = 1200, pointsActive = 750, minEnergy = 5},
            [16] = {modifier = 80, pointsPassive = 1280, pointsActive = 800, minEnergy = 6},
            [17] = {modifier = 85, pointsPassive = 1360, pointsActive = 850, minEnergy = 6},
            [18] = {modifier = 90, pointsPassive = 1440, pointsActive = 900, minEnergy = 6},
            [19] = {modifier = 95, pointsPassive = 1520, pointsActive = 950, minEnergy = 7},
            [20] = {modifier = 100, pointsPassive = 1600, pointsActive = 1000, minEnergy = 7},
        },
    },
